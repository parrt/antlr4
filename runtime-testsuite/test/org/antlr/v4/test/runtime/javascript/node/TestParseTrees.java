...
public class TestParseTrees extends BaseTest {
	...
	public void testAltNum() throws Exception {
		mkdir(tmpdir);
		StringBuilder grammarBuilder = new StringBuilder(746);
		grammarBuilder.append("grammar T;\n");
		grammarBuilder.append("\n");
		grammarBuilder.append("options { contextSuperClass=MyRuleNode; }\n");
		grammarBuilder.append("@parser::members {\n");
		grammarBuilder.append("// sorry I just can't figure this stupid javascript fake class shit out...\n");
		grammarBuilder.append("this.MyRuleNode = function() {\n");
		grammarBuilder.append("	function ParserRuleContext(parent, invokingStateNumber) {\n");
		grammarBuilder.append("		ParserRuleContext.call(this, parent, invokingStateNumber);\n");
		grammarBuilder.append("		this.altNum = 0;\n");
		grammarBuilder.append("	}\n");
		grammarBuilder.append("\n");
		grammarBuilder.append("	public int altNum;\n");
		grammarBuilder.append("	public int getAltNumber() { return altNum; }\n");
		grammarBuilder.append("	@Override public void setAltNumber(int altNum) { this.altNum = altNum; }\n");
		grammarBuilder.append("}\n");
		grammarBuilder.append("\n");
		grammarBuilder.append("MyRuleNode.prototype = Object.create(ParserRuleContext.prototype);\n");
		grammarBuilder.append("MyRuleNode.prototype.constructor = RuleContext;\n");
		grammarBuilder.append("}\n");
		grammarBuilder.append("\n");
		grammarBuilder.append("s\n");
		grammarBuilder.append("@init {\n");
