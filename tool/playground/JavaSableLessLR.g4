...
grammar JavaSableLessLR;
  ...
  interface_type_list :
     ((type_decl_specifier type_arguments?)) (',' (type_decl_specifier type_arguments?))*;
  ...
  abstract_method_modifiers :
     (abstract_method_modifier) (abstract_method_modifier)*;
...
/*
  ...
  relational_expression :
     (shift_expression) ('<' shift_expression | '>' shift_expression | '<=' shift_expression | '>=' shift_expression | 'instanceof' ((type_name type_arguments?) ('.' Identifier type_arguments?)* |
     type_variable |
     type '[' ']'))*
     ;
