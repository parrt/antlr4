/*
TJP converted to ANTLR v4.

From Arik Ter-Galstyan:
Verilog grammar for ANTLR v3 converted from ANTLR v2 verilog grammar written by
Steve Eckmann from Argonne National Lab.
*/
grammar Verilog;
...
input_declaration :
        'input' ( net_type )? ( 'signed' )? (range)? list_of_variables SEMI
        ;
...
inout_declaration :
        'inout' ( net_type )? ( 'signed' )? (range)? list_of_variables SEMI
        ;
